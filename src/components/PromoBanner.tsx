...
const banners = [
  ...
  },
  {
    ...
    subtitle: { fr: 'Wave, Orange Money, MTN MoMo, Moov Money. Votre argent est libéré après réception de la bonne pièce.', en: 'Wave, Orange Money, MTN MoMo, Moov Money. Your funds are released after part inspection.' },
