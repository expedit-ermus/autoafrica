          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex items-center justify-center gap-8">
              <div className="text-center">
                <div className="w-14 h-14 bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-accent-warm)] rounded-2xl flex items-center justify-center mb-3 mx-auto shadow-lg shadow-[var(--color-primary)]/30">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-sm text-white/70">
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Qui sommes-nous ?', 'About us?')}</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Programme Bonus', 'Bonus Program')}</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Appli AutoAfrique', 'AutoAfrique App')}</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Marketplace', 'Marketplace')}</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-white font-bold mb-5 text-sm tracking-wide">{L('AIDE ET SOUTIEN', 'HELP & SUPPORT')}</h4>
              <ul className="space-y-3 text-sm text-white/70">
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Blog', 'Blog')}</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Manuels de réparation', 'Repair manuals')}</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Conditions générales', 'Terms & conditions')}</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Politique de confidentialité', 'Privacy policy')}</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-white font-bold mb-5 text-sm tracking-wide">{L('SERVICE CLIENTS', 'CUSTOMER SERVICE')}</h4>
              <ul className="space-y-3 text-sm text-white/70">
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Centre d\'aide', 'Help center')}</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Paiement', 'Payment')}</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Livraison', 'Delivery')}</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Nous contacter', 'Contact us')}</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Retours', 'Returns')}</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-white font-bold mb-5 text-sm tracking-wide">{L('PRODUITS', 'PRODUCTS')}</h4>
              <ul className="space-y-3 text-sm text-white/70">
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Pneus & Jantes', 'Tyres & Rims')}</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Frein', 'Brakes')}</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Moteur', 'Engine')}</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Filtres', 'Filters')}</a></li>
                <li><a href="#" className="hover:text-[var(--color-primary)] transition-colors font-medium">{L('Huiles & fluides', 'Oils & fluids')}</a></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                <a href="#" className="w-10 h-10 rounded-xl bg-white/10 hover:bg-[var(--color-primary)]/20 flex items-center justify-center transition-all border border-white/10">
