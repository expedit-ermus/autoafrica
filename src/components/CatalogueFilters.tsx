      ...
      <div className="mb-6">
        <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between mb-5">
          ...
          <div className="flex items-center gap-2">
            <label htmlFor="trier-par" className="text-xs font-semibold text-gray-500 whitespace-nowrap">Trier par :</label>
            <select id="trier-par"
              value={sortBy}
        ...
        <div className="relative mb-5">
          ...
          <input aria-label="Rechercher une pièce (ex: Plaquette Hilux, Filtre à huile, Bougie...)"
            type="text"
            value={search}
        ...
        <div className={`${showMobileFilters ? 'block' : 'hidden sm:block'} space-y-4`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-3 border-t border-gray-100">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <input aria-label="Prix minimum en FCFA"
                ...
                <input aria-label="Prix maximum en FCFA"
                  type="number" inputMode="numeric"
                  placeholder="Max"
                  value={maxPrice}
