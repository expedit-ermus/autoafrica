        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-5 py-3.5 border-2 border-[var(--color-warm-border)] rounded-xl text-gray-900 focus:border-emerald-600 focus:outline-none transition-colors bg-white font-medium cursor-pointer"
            >
