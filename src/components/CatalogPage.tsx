  ...
  return (
    <div className="bg-[var(--color-bg)]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <nav className="flex items-center gap-2 text-sm text-[var(--color-warm-muted)] mb-6" aria-label="Fil d'Ariane">
        ...
        <div className="max-w-3xl">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold text-[var(--color-warm-ink)] mb-4 tracking-tight">
        ...
        <div className="mt-10">
          ...
          {products.length === 0 ? (
            <div className="bg-white rounded-2xl border border-[var(--color-warm-border)] p-10 text-center">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-accent-warm)] text-white font-bold transition-all shadow-lg shadow-[var(--color-primary)]/30"
              >
            ...
            <>
              ...
              <div className="text-center mt-10">
                <Link
                  href={MARKETPLACE_URL}
                  className="inline-flex items-center gap-2 px-8 py-4 bg-[var(--color-bg-warm)] hover:bg-[var(--color-primary)] hover:text-white text-[var(--color-warm-ink)] font-bold rounded-xl transition-all border border-[var(--color-warm-border)]"
                >
