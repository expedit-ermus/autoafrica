    ...
    <div className="space-y-4">
      ...
      {showForm && (
        <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
          ...
          <input className="input-field" placeholder="Titre (optionnel)" value={form.title} onChange={e => setForm({ ...form, title: e.target.value })} />
          <textarea className="input-field" rows={3} placeholder="Votre avis *" value={form.comment} onChange={e => setForm({ ...form, comment: e.target.value })} />
