  ...
  const flows: Record<string, () => FlowResult> = {
    ...
    search_by_city: () => ({
      ...
      options: [
        ...
        { label: '📍 Bouaké', action: 'search_mercedes', icon: '📍' },
        { label: '📍 Yamoussoukro', action: 'search_bmw', icon: '📍' },
        { label: '📍 Korhogo', action: 'search_kia', icon: '📍' },
        { label: '📍 San-Pédro', action: 'search_by_city', icon: '📍' },
