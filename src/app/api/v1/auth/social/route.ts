...
export async function GET(request: NextRequest) {
  ...
  if (provider === 'google') {
    const clientId = process.env.GOOGLE_CLIENT_ID || '1048293740284-demo-autoafrique.apps.googleusercontent.com'
    ...
    const appId = process.env.FACEBOOK_APP_ID || '1048293740284920'
