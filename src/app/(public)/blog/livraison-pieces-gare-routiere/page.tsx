      ...
      contentSections={[
        {
          ...
          body: [
            'En Côte d\'Ivoire et en Afrique de l\'Ouest, les compagnies de transport par car (UTB, CTE, STIF, SBTA, etc.) constituent le réseau de messagerie le plus rapide et le plus économique pour relier la capitale économique aux villes de l\'intérieur.',
        ...
        },
        {
          ...
          body: [
            ...
            '2. Expédition Intérieur du Pays (24-48h) : Dépôt sécurisé en gare routière partenaire avec transmission immédiate du numéro de bordereau et du numéro du convoyeur.',
        ...
        },
        {
          ...
          body: [
            ...
            '- Moteurs et boîtes de vitesses : Vidange complète obligatoire pour éviter les fuites d\'huile, fixation sur palette et film étirable épais.',
            '- Optiques de phares, rétroviseurs et pare-brise : Double emballage à bulles et carton rigide renforcé avec mention visible FRAGILE.',
            '- Électronique (calculateurs, injecteurs, capteurs) : Protection antistatique et calage mousse hermétique à l\'humidité.',
          ],
        },
        {
          id: 'suivi-securite',
          ...
          body: [
            ...
            'À la réception en gare, l\'acheteur vérifie le colis, valide sur son espace client, et le paiement Mobile Money est alors immédiatement libéré au vendeur.',
          ],
        },
        {
          id: 'tarifs-delais',
