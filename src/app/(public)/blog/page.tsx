...
export default function BlogIndexPage() {
  ...
  const articles = [
    ...
    },
    {
      ...
      title: L('Comment choisir une pièce d\'occasion contrôlée ?', 'How to choose quality-inspected used parts?'),
      category: L('Guide d\'achat', 'Buying guide'),
      categoryColor: 'bg-blue-100 text-blue-800 border-blue-200',
      excerpt: L('Neuf ou occasion ? Voici comment vérifier la qualité d\'une pièce de réemploi avant l\'achat.', 'New or used? Here\'s how to check the quality of a reused part before buying.'),
      date: L('10 Août 2026', 'Aug 10, 2026'),
      readTime: L('6 min', '6 min'),
    },
    {
      slug: 'paiement-mobile-money-auto',
      title: L('Mobile Money et pièces auto : payer en toute sécurité', 'Mobile Money and auto parts: pay securely'),
      category: L('Paiement', 'Payment'),
      categoryColor: 'bg-purple-100 text-purple-800 border-purple-200',
      excerpt: L('Wave, Orange Money, MTN MoMo : comment le séquestre Mobile Money protège vendeurs et acheteurs.', 'Wave, Orange Money, MTN MoMo: how mobile money escrow protects sellers and buyers.'),
