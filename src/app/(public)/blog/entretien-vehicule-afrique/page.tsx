      ...
      contentSections={[
        {
          ...
          body: [
            ...
            'De plus, la poussière latéritique s\'infiltre partout, nécessitant des remplacements de <a href="/categories/filtre">filtres auto</a> plus fréquents. Les routes dégradées soumettent la <a href="/categories/suspension">suspension et les amortisseurs</a> à des contraintes intenses.',
          ],
        },
        {
          id: 'dix-points',
          ...
          subsections: [
            { heading: '1. L\'huile moteur', body: 'Le sang de votre moteur. En raison des fortes chaleurs, optez pour une huile adaptée (10W40 ou 15W40 selon les préconisations). Vidangez tous les 5 000 à 7 500 km avec un <a href="/categories/filtre">filtre à huile neuf</a>.' },
            ...
            { heading: '3. Les filtres (air, huile, carburant, habitacle)', body: 'Le <a href="/categories/filtre">filtre à air</a> souffre particulièrement de la poussière. Remplacez-le à chaque vidange. Le filtre à carburant protège vos injecteurs d\'éventuelles impuretés de carburant.' },
