...
export default function EntretienVehiculeAfriquePage() {
  return (
    <ArticlePageTemplate
      ...
      contentSections={[
        {
          ...
          body: [
            ...
            'De plus, la poussière latéritique s\'infiltre partout, nécessitant des remplacements de <a href="/categories/moteur">filtres auto</a> plus fréquents. Les routes dégradées soumettent la <a href="/categories/suspension">suspension et les amortisseurs</a> à des contraintes intenses.',
          ],
        },
        {
          id: 'dix-points',
          ...
          subsections: [
            { heading: '1. L\'huile moteur', body: 'Le sang de votre moteur. En raison des fortes chaleurs, optez pour une huile adaptée (10W40 ou 15W40 selon les préconisations). Vidangez tous les 5 000 à 7 500 km avec un <a href="/categories/moteur">filtre à huile neuf</a>.' },
            ...
            { heading: '3. Les filtres (air, huile, carburant, habitacle)', body: 'Le <a href="/categories/moteur">filtre à air</a> souffre particulièrement de la poussière. Remplacez-le à chaque vidange. Le filtre à carburant protège vos injecteurs d\'éventuelles impuretés de carburant.' },
            ...
            { heading: '5. Le système de freinage', body: 'Les <a href="/categories/frein">plaquettes et disques de frein</a> s\'usent vite en circulation urbaine. Un bruit strident au freinage est le signe qu\'il est temps de les changer.' },
            ...
            { heading: '9. L\'éclairage', body: 'Vérifiez que tous vos <a href="/categories/carrosserie">feux et optiques</a> fonctionnent (croisement, route, clignotants, stops) pour voir et être vu.' },
      ...
      resources={[
        { title: 'Catalogue Filtres', description: 'Filtres à air, huile, carburant et habitacle pour toutes marques.', href: '/categories/moteur' },
        { title: 'Catalogue Freinage', description: 'Plaquettes, disques et kits de frein inspectés.', href: '/categories/frein' },
        { title: 'Huiles & Fluides', description: 'Huiles moteur, liquides de refroidissement et de frein.', href: '/categories/refroidissement' },
        { title: 'Pneus & Jantes', description: 'Pneus neufs et d\'occasion contrôlée pour toutes marques.', href: '/catalogue' },
      ]}
      cta={{
