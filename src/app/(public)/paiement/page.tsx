...
export const metadata: Metadata = {
  ...
  description:
    "Paiement sécurisé par Mobile Money sur AutoAfrique : Orange Money, MTN MoMo, Moov Money, Wave, Djamo. Prix en FCFA affiché, aucune donnée bancaire, reçu dans votre compte.",
};
      ...
      sections={[
        {
          ...
          body: [
            'Orange Money (Côte d\'Ivoire, Sénégal, Mali, Burkina Faso, Bénin, Niger, Togo), Wave (Sénégal, Mali, Burkina Faso, Côte d\'Ivoire), Djamo (Côte d\'Ivoire, Sénégal), MTN MoMo (Côte d\'Ivoire, Sénégal, Ghana, Cameroun, Nigeria) et Moov Money (Côte d\'Ivoire, Bénin, Togo, Burkina Faso).',
