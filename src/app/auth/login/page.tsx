  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (redirectTo && redirectTo.startsWith('/')) {
        ...
        const adminRoles = ['SUPER_ADMIN', 'TENANT_ADMIN', 'MODERATOR', 'SUPPORT'];
      ...
      // intentionally empty – redirect handled above
          ...
          <div className="space-y-4">
            {[
              ...
              { icon: (
                ...
                ), label: 'Paiements Sécurisés', desc: 'Mobile Money' },
              { icon: (
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-8 lg:p-12">
        <div className="w-full max-w-md">
          ...
          <div className="lg:bg-transparent lg:p-0 p-8 lg:rounded-none rounded-2xl" style={{ background: 'rgba(255,255,255,0.8)', backdropFilter: 'blur(20px) saturate(180%)', WebkitBackdropFilter: 'blur(20px) saturate(180%)' }}>
            ...
            {/* Social login buttons - Active Google & Facebook */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3 mb-6 auth-fade-in-delay-3">
              <button
                type="button"
